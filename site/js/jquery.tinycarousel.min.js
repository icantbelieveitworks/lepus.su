...
;(function ($) 
{
    ...
    function Carousel(root, options)
    {
        ...
        this.move  = function (iDirection, bPublic)
        {
            ...
            {
                var oPosition = {};
                oPosition[bAxis ? 'left' : 'top'] = -(iCurrent * (iPageSize * 4));    
       ...
       function initialize () {
			iPageSize = 219;
            var iLeftover = Math.ceil(((bAxis ? oViewport.outerWidth() : oViewport.outerHeight()) / (iPageSize * 4)) -1);
            iSteps = Math.max(1, Math.ceil(oPages.length / 4) - iLeftover);
