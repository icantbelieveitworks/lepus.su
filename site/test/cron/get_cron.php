...
$dir = "/var/www/lepus/test/cron/task";
$data = json_decode(file_get_contents("https://lepus.dev/public/api/cron.php?passwd=".md5('secret'), false, stream_context_create($arrContextOptions)), true);
